...
#define  LCD_RS_PORT		DIO_PORT_A
#define  LCD_RW_PORT		DIO_PORT_A
#define  LCD_EN_PORT		DIO_PORT_A
...
//options are: { DIO_PORT_A, DIO_PORT_B, DIO_PORT_C, DIO_PORT_D }
#define  LCD_D0_PORT        DIO_PORT_A
#define  LCD_D1_PORT        DIO_PORT_A
#define  LCD_D2_PORT        DIO_PORT_A
#define  LCD_D3_PORT        DIO_PORT_A
#define  LCD_D4_PORT        DIO_PORT_A
#define  LCD_D5_PORT        DIO_PORT_A
#define  LCD_D6_PORT        DIO_PORT_A
#define  LCD_D7_PORT        DIO_PORT_A
/*    Choose PIN number for Data pins*/
//options are: { DIO_PIN0 : DIO_PIN7 }
#define  LCD_D0_PIN         DIO_PIN0
#define  LCD_D1_PIN         DIO_PIN0
#define  LCD_D2_PIN         DIO_PIN0
#define  LCD_D3_PIN         DIO_PIN0
